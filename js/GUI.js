...
function  initGUIElements() {
    ...
    var countdownDiv = document.getElementById("divCountdown")
    countdownDiv.style.width = "100px";
    countdownDiv.style.height = "50px"

    var displayCanvasContext = document.getElementById('displayCanvas').getContext('2d');
    healthBar = new HealthBar(displayCanvasContext, 15, 1, 50, 5, 100, 100);
    var healthBarImage = document.getElementById("healthIcon")
    healthBarImage.style.width = "50px";
    healthBarImage.style.height = "25px";

    energyBar = new HealthBar(displayCanvasContext, 100, 1, 50, 5, 100, 100);
    var energyBarImage = document.getElementById("canisterIcon")
    energyBarImage.style.position = "absolute";
    energyBarImage.style.width = "50px";
    energyBarImage.style.height = "25px";
    energyBarImage.style.left = "350px";
