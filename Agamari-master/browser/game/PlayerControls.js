	...
	this.checkKeyStates = function () {
	    ...
	    if (keyState[38] || keyState[87] && !isChatting) {
          ...
          this.cannonMesh.applyImpulse(new CANNON.Vec3(
													   -cross2.x * 150 * (0.833 + this.scale/6) *this.speedMult,
													   -cross2.z * 150 * (0.833 + this.scale/6) *this.speedMult,
													   -cross2.y * 150 * (0.833 + this.scale/6) *this.speedMult
													   ),topOfBall);
	    }
	    ...
	    if (keyState[37] || keyState[65] && !isChatting) {
	        ...
	        this.cannonMesh.applyImpulse(new CANNON.Vec3(cross1.x * 100 * (0.833 + this.scale/6) * this.speedMult,
														 cross1.z * 100 * (0.833 + this.scale/6) * this.speedMult,
														 cross1.y * 100 * (0.833 + this.scale/6) * this.speedMult
														 ) ,topOfBall);
	        this.left = true;
	    }
	    ...
	    if (keyState[39] || keyState[68] && !isChatting) {
            ...
            this.cannonMesh.applyImpulse(new CANNON.Vec3(
														 -cross1.x * 100 * (0.833 + this.scale/6) * this.speedMult,
														 -cross1.z * 100 * (0.833 + this.scale/6) * this.speedMult,
														 -cross1.y * 100 * (0.833 + this.scale/6) * this.speedMult
														 ), topOfBall);
            this.right = true;
